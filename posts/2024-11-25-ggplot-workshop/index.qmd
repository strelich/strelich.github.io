...
format: 
  html: 
    df-print: paged
image: "index_files/figure-html/unnamed-chunk-36-1.png"
---
...
We'll be working with a simulated data set today (`data-viz.csv`); you can download it [here](www.google.com). All the packages we'll need can be loaded via `library(tidyverse)`:
